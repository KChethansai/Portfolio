...
const Shuffle = ({
  ...
  const baseTw = 'inline-block whitespace-normal break-words will-change-transform uppercase text-6xl md:text-8xl lg:text-9xl leading-none font-bold text-white tracking-widest';
